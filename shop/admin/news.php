...
<thead>
        ...
        <a href="./addN.php"><button style="width:100px;height:40px;background-color:lightblue;margin-left:50px;position:relative;top:50px;left:100px;"><b>SHTO LAJM</b></button></a>
