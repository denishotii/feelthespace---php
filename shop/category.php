          ...
          <div class="title__container tabs">
            <div class="section__titles category__titles ">
              <div id="divAllP-1" class="section__title filter-btn active" data-id="All Products">
                <!-- <span class="dot"></span> -->
                <h1 id="divAllP" class="primary__title" style="text-transform: uppercase"><b><?= $category ?></b> products</h1>
              </div>
            </div>
...
include "./db/db.php";
$selectP = "SELECT * FROM products where category='$category' order by rand() ";
