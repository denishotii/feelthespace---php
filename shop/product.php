        ...
        <div class="product-detail__container">
          <div class="product-detail__left">
            ...
            <div class="product-details__btn">
              <a class="add" href="inc/addToCart.php?pId=<?php echo $id?>&url=<?php echo $_SERVER['PHP_SELF']."?".$_SERVER['QUERY_STRING']?>">
                <span>
                  <svg>
          ...
          <div class="product-detail__right marginclass">
            <div class="product-detail__content" style="text-align: center;">
              <h3><?php echo $fileName?></h3>
              <div class="price" style="text-align: center;">
                <?php if($save != null){ ?>
                  <span class="old__price"><s><?= $price ?></s></span><br><br>
                  <span class="kurseni">You SAVE: <?= $price-$dPrice."€ (".$save."%)" ?></span><br><br>
                  <span class="new__price" style="font-size: 34px; font-weight: bolder;color: black;"><?php echo $dPrice." €" ?></span>
              <?php
                }
                else{ ?>
                <span class="new__price" style="font-size: 34px; font-weight: bolder;color: black;"><?php echo $price." €" ?></span>
                <?php } ?>
              </div><br><br>
                ...
                <ul class="product__info">
                  ...
                  <li>
                    ...
                    <?php 
                     if ($availability > 0) {
                      ?> 
                        <a href="#" class="in-stock">In stock (<?php echo $availability ?> products)</a>
                    <?php
                     }else{
                    ?>
                    <a href="#" class="in-stock" style="color:red;" >Sorry, We don't have this product in stock for moment! :(</a>
                    <?php } ?>
                  </li>
                </ul>
              </div>
